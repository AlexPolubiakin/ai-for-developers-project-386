...
- [x] 14. Упростить Prisma schema: оставить только сущности, нужные для MVP
- [x] 15. Реализовать owner endpoints для списка и создания типов событий
- [x] 16. Реализовать публичные endpoints получения типов событий
- [x] 17. Реализовать генерацию свободных слотов на 14 дней
- [x] 18. Реализовать создание бронирования с проверкой конфликта
- [x] 19. Реализовать owner endpoint списка предстоящих подтвержденных встреч
- [x] 20. Обновить seed под данные, совпадающие со скриншотами

## Frontend MVP

- [x] 21. Заменить Vite starter на реальное приложение
- [x] 22. Реализовать общий header/layout по скриншотам
- [x] 23. Сверстать лендинг `/`
- [x] 24. Сверстать страницу выбора типов событий
- [x] 25. Сверстать booking flow: выбор даты, слота, форма гостя, подтверждение
- [x] 26. Сверстать страницу предстоящих событий
- [x] 27. Добавить простую owner-форму создания типа события
- [x] 28. Подключить frontend к owner/public backend endpoints
- [x] 29. Добавить базовые loading/error/empty состояния

## Verification

- [x] 30. Проверить TypeSpec-компиляцию
- [x] 31. Проверить backend lint/test/build
- [x] 32. Проверить frontend lint/build
